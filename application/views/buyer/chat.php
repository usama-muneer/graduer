...
// show message
  $(document).ready(function () {
    ...
    $('div').animate({
        scrollTop: $('#what1').get(0).scrollHeight
    }, 10);
  });
</script>
        ...
        <ul>
          ...
          <li>
            <div class="chat-left-img">
              <img src="<?php echo base_url('images/resized/').$picture; ?>" class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="tooltip" data-placement="bottom" title="Profile" alt="profile">
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
      					<a class="dropdown-item" href="<?php echo base_url('Chatc/chat/'.$row['sender_id']); ?>">Send Message</a>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 right-header">
          <div class="right-header-img">
            <img src="<?php echo base_url('images/thumbnail/').$picture; ?>">
          </div>
