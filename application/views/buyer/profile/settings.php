...
<div class="container padding10 border rounded">
  <h3>Settings</h3>
  <hr/>
  <form method="post" action="<?php echo base_url(); ?>bprofilec/changepassword">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?php echo base_url(); ?>bprofilec/deactivate_profile" class="btn btn-danger">Deactivate</a>
      </div>
    </div>
  </div>
</div>
