...
<!-- ORDER START -->
    ...
    <div class="padding10">
      ...
      <hr>
        ...
        ?>
        <h5 align="center" class="text-info">*Waiting for buyer response*</h5>
        <br><br>
      </div>
    </div>
    <!-- DELIVER ORDER END -->
    ...
    <div class="padding10">
      <div class="container padding10 border rounded bg-light">
        <h2 align="center"><a href="<?php echo base_url('bchatc/chat/'.$buyer_id); ?>" class="btn btn-success" align="center">Contact Buyer</a></h2>
        <br><br>
      </div>
    </div>
